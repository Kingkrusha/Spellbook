...
A desktop application for managing D&D 5th Edition spells with search, filter, character spell lists, and stat block management.
...
- **Class Support**: All D&D 5e spellcasting classes plus a Custom class option
...
#### Main Components
- **`MainWindow`**: Tab-based layout with Spells and Spell Lists views
...
This project is for personal use. D&D content is property of Wizards of the Coast.
